...
export default function SubmitPanel() {
  ...
  }, [audioBlob, location, resetRecording])

  return (
    <div className="panel submit-panel">
      <div className="panel-header">
        <span className="panel-header-title">RECORD A FART</span>
      </div>
              ...
              {!recording ? (
                <button
                  ...
                  style={{
                    ...
                    borderColor: '#ff6b6b',
                    color: '#ff6b6b',
                    boxShadow: '0 0 20px rgba(255,77,90,0.2), 0 0 40px rgba(255,77,90,0.08)',
